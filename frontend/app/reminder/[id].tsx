...
import { Check, Clock3, Pill, TimerReset } from "lucide-react-native";
...
export default function ReminderScreen() {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top", "bottom"]}>
      <View style={styles.top}><View style={styles.clock}><Clock3 size={23} color={colors.primary} /><Text style={styles.time}>{time}</Text></View><Text style={styles.prompt}>It&apos;s medicine time</Text></View>
      ...
      <View style={styles.actions}><BigButton testID="reminder-taken-button" label="Taken" icon={Check} onPress={taken} /><BigButton testID="reminder-snooze-button" label="Snooze 10 minutes" icon={TimerReset} variant="secondary" onPress={snooze} /></View>
    </SafeAreaView>
  );
}
...
const styles = StyleSheet.create({
  ...
  details: { flex: 1, alignItems: "center", justifyContent: "center", paddingVertical: 18 }, name: { color: colors.text, fontSize: 32, lineHeight: 39, fontWeight: "900", textAlign: "center" }, dosage: { color: colors.textSecondary, fontSize: 21, fontWeight: "700", textAlign: "center", marginTop: 8 }, actions: { gap: 12, paddingBottom: 4 },
});